...
- **rubric**: Structured rubric evaluation
- **output_quality**: Summary quality assessment with score (1-10), strengths, weaknesses
...
- **Be objective**: Focus on correctness and completeness
